...
`./install.sh` to install. This may overwrite your existing configs.
...
But I break that on a semi-monthly basis, so I also run an X compositor setup that goes something like this:
